...
import com.sewz.mobile_oa.ui.shenpi.fragment.PurchaseNoFragment;
import com.sewz.mobile_oa.ui.shenpi.fragment.PurchaseOkFragment;
import com.sewz.mobile_oa.ui.shenpi.fragment.PurchaseSendMeFragment;
 ...
 * 物品采购审批
 */
public class PurchaseSpActivity extends BaseActivity implements View.OnClickListener {
    ...
    PurchaseOkFragment purOkFragment;
    PurchaseNoFragment purNoFragment;
    PurchaseSendMeFragment purSendMeFragment;
    ...
    protected int getContentViewId() {
        return R.layout.activity_purchase_sp;
    }
    ...
    private void initClickListener() {
        ...
        purNoFragment = new PurchaseNoFragment();
        purOkFragment = new PurchaseOkFragment();
        purSendMeFragment = new PurchaseSendMeFragment();

        fragmentList.add(purNoFragment);
        fragmentList.add(purOkFragment);
        fragmentList.add(purSendMeFragment);
