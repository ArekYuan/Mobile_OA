...
public class ApplyAdapter extends RecyclerView.Adapter<ApplyAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public List<ApplyResp.DataBean> getData() {
        return data;
    }
    ...
    public void setRefreshData(List<ApplyResp.DataBean> data) {
        this.data.clear();
        this.data.addAll(data);
        notifyDataSetChanged();
    }

    public void setLoadData(List<ApplyResp.DataBean> data) {
        this.data.addAll(data);
        notifyDataSetChanged();
    }

    private List<ApplyResp.DataBean> data = new ArrayList<>();
    private Context mContext;
    private LayoutInflater mInflater;
    private int layoutId;

    public ApplyAdapter(Context mContext, int layoutId) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ApplyResp.DataBean bean = data.get(position);
...
//        holder.contentTxt.setText(bean.getContentStr());
        holder.gongGaoImgView.setImageResource(R.mipmap.icon_apply);
