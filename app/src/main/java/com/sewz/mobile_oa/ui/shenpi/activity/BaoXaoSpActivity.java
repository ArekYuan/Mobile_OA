...
import com.sewz.mobile_oa.ui.shenpi.fragment.BaoXaoNoFragment;
import com.sewz.mobile_oa.ui.shenpi.fragment.BaoXaoOkFragment;
import com.sewz.mobile_oa.ui.shenpi.fragment.BaoXaoSendMeFragment;
...
public class BaoXaoSpActivity extends BaseActivity implements View.OnClickListener {
    ...
    BaoXaoOkFragment baoXaoOkFragment;
    BaoXaoNoFragment baoXaoNoFragment;
    BaoXaoSendMeFragment baoXaoSendMeFragment;
    ...
    protected int getContentViewId() {
        return R.layout.activity_bao_xao_sp;
    }
    ...
    private void initClickListener() {
        ...
        baoXaoNoFragment = new BaoXaoNoFragment();
        baoXaoOkFragment = new BaoXaoOkFragment();
        baoXaoSendMeFragment = new BaoXaoSendMeFragment();

        fragmentList.add(baoXaoNoFragment);
        fragmentList.add(baoXaoOkFragment);
        fragmentList.add(baoXaoSendMeFragment);
