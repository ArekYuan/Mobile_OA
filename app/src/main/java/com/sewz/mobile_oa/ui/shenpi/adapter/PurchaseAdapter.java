...
public class PurchaseAdapter extends RecyclerView.Adapter<PurchaseAdapter.ViewHolder> implements View.OnClickListener {

    public List<PurchaseResp.DataBean> getData() {
        return data;
    }
    ...
    private List<PurchaseResp.DataBean> data = new ArrayList<>();
    private Context mContext;
    private LayoutInflater mInflater;
    private int layoutId;

    public PurchaseAdapter(Context mContext, int layoutId) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        PurchaseResp.DataBean bean = data.get(position);
...
//        holder.contentTxt.setText(bean.getContentStr());
        holder.gongGaoImgView.setImageResource(R.mipmap.icon_purchase);
