...
import com.sewz.mobile_oa.ui.shenpi.fragment.ApplyNoFragment;
import com.sewz.mobile_oa.ui.shenpi.fragment.ApplyOkFragment;
import com.sewz.mobile_oa.ui.shenpi.fragment.ApplySendMeFragment;
...
public class ApplySpActivity extends BaseActivity implements View.OnClickListener {
    ...
    ApplyOkFragment applyOkFragment;
    ApplyNoFragment applyNoFragment;
    ApplySendMeFragment applySendMeFragment;
...
//    FragmentManager fragmentManager;
    ...
    private void initClickListener() {
        ...
        applyNoFragment = new ApplyNoFragment();
        applyOkFragment = new ApplyOkFragment();
        applySendMeFragment = new ApplySendMeFragment();

        fragmentList.add(applyNoFragment);
        fragmentList.add(applyOkFragment);
        fragmentList.add(applySendMeFragment);

//        fragmentManager = getSupportFragmentManager();
        homePager.setAdapter(new MyFragmentPagerAdapter(getSupportFragmentManager()));
