...
import com.sewz.mobile_oa.ui.shenpi.fragment.RepairNoFragment;
import com.sewz.mobile_oa.ui.shenpi.fragment.RepairOkFragment;
import com.sewz.mobile_oa.ui.shenpi.fragment.RepairSendMeFragment;
...
public class RepairSpActivity extends BaseActivity implements View.OnClickListener {
    ...
    RepairOkFragment repairOkFragment;
    RepairNoFragment repairNoFragment;
    RepairSendMeFragment repairSendMeFragment;
    ...
    protected int getContentViewId() {
        return R.layout.activity_repair_sp;
    }
    ...
    private void initClickListener() {
        ...
        repairNoFragment = new RepairNoFragment();
        repairOkFragment = new RepairOkFragment();
        repairSendMeFragment = new RepairSendMeFragment();

        fragmentList.add(repairNoFragment);
        fragmentList.add(repairOkFragment);
        fragmentList.add(repairSendMeFragment);
