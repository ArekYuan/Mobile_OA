...
public class RepairAdapter extends RecyclerView.Adapter<RepairAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public List<RepairResp.DataBean> getData() {
        return data;
    }

    public void setRefreshData(List<RepairResp.DataBean> data) {
        this.data.clear();
        this.data.addAll(data);
        notifyDataSetChanged();
    }

    public void setLoadData(List<RepairResp.DataBean> data) {
        this.data.addAll(data);
        notifyDataSetChanged();
    }

    private List<RepairResp.DataBean> data = new ArrayList<>();
    private Context mContext;
    private LayoutInflater mInflater;
    private int layoutId;

    public RepairAdapter(Context mContext, int layoutId) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        RepairResp.DataBean bean = data.get(position);
...
//        holder.contentTxt.setText(bean.getContentStr());
        holder.gongGaoImgView.setImageResource(R.mipmap.icon_repair);
