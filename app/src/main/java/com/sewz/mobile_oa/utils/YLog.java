...
public class YLog implements Thread.UncaughtExceptionHandler {
    ...
    private static final String SDCARD_ROOT = Environment.getExternalStorageDirectory().toString() + File.separator + "wjl" + File.separator;
...
//        }
    ...
    public static String getCrashPath(Context context) {
        String crashpath = createNewFile(getCacheFilePath(context) + "suning" + File.separator + "crash" + ERROR_LOG_SUFFIX);
        return crashpath;
    }
